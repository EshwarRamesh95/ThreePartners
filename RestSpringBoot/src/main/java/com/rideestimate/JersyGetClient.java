...
public class JersyGetClient {
	...
	public List<Map<String, Object>> searchOla() {
		WebTarget targetAvailable = client.target(getURI(olaAvailableUrl));
...
*/
	...
	public Map<String, Object> searchUber() {
		...
		String fareResponse = target.queryParam("pickupRef",
		  "ChIJoXMoCLJmUjoR-DEq5GBvK38").queryParam("pickupRefType", "google_places")
		  .queryParam("pickupLat", "13.0381896").queryParam("pickupLng",
		  "80.1565461").queryParam("destinationRef", "ChIJmQqEB0lhUjoRJoornnUIh6g")
